...
/* Alle Privatpersonen */
SELECT nachname, vorname, email, strasse, hausnummer, plz, ort, land FROM teilnehmer JOIN firma ON teilnehmer.fnummer = firma.fnummer AND firma.firmenname = "privat";
